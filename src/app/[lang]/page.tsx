      ...
      <section className="py-16 md:py-24 bg-black/20">
        <div className="container mx-auto px-4">
          <div className="mb-12 text-center">
            ...
            <p className="text-white/70 max-w-2xl mx-auto">
              Utforska vårt tvådagars program med keynotes, paneldiskussioner
              och workshops
            </p>
          </div>
          <ProgramSchedule />
        ...
        <div className="container mx-auto px-4">
          <div className="glass-strong rounded-glass p-8 md:p-12 text-center max-w-3xl mx-auto">
            ...
            <p className="mb-8 text-white/70">
              Anmäl dig idag och ta del av två dagar av djupgående diskussioner
              om juridik, samhälle och framtiden.
            </p>
            <a
              href={`/${lang}/about`}
