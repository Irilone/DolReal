  ...
  return (
    ...
    >
        ...
        >
          <div className="bg-white text-black p-6 rounded-lg max-w-2xl w-full relative">
            ...
            <div className="flex gap-3 justify-end">
              <Button
                onClick={() => setActiveStream(nodes.findIndex((n) => n.name === activeNode) || 0)}
              >
                Open Stream
              </Button>
      ...
      <section id="streams" className="py-12 bg-black/40" aria-labelledby="streams-title">
        <h2 id="streams-title" className="text-center text-xl font-semibold mb-6">
          Live Streams
        </h2>
      ...
      <section id="program" className="py-12 px-4" aria-labelledby="program-title">
        <h2 id="program-title" className="text-center text-xl font-semibold mb-6">
          Program Schedule
        </h2>
